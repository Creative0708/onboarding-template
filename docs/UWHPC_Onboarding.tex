...
The two \code{operator()} overloads give read/write and read-only access to the cell at row \code{i}, column \code{j}. The evaluation harness uses only these overloads to set initial conditions and read back your results, so they must work no matter how you store the field internally. The implementation of everything else is up to you. We want to see how you think and how you approach such problems.
...
\begin{enumerate}[leftmargin=1.5em, itemsep=0.2em]
    ...
    \item You are free to choose the memory layout and overall design of the Grid class. Be prepared to discuss your decisions during the interview.
\end{enumerate}
...
\noindent The boundary copy below is illustrative; the interior update is up to you.
...
\begin{enumerate}[leftmargin=1.5em, itemsep=0.2em]
    \item \code{grid.hpp} --- containing your Grid implementation.
    \item \code{stencil.cpp} --- containing your stencil implementation.
\end{enumerate}
